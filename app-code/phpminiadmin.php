...
*/
 ...
 $ACCESS_PWD='karkeeABCqwe123'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access

 #DEFAULT db connection settings
 # --- WARNING! --- if you set defaults - it's recommended to set $ACCESS_PWD to protect your db!
 $DBDEF=array(
 'user'=>"KarkeeUser#2",#required
 'pwd'=>"KarkeeUser#2", #required
 'db'=>"db_karkee_staging",  #optional, default DB
 'host'=>"",#optional
 'port'=>"",#optional
